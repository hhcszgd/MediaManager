...
class DDAlertOrSheet: DDAlertContainer {
    ...
    public  init(title: String? = nil , message: String? = nil , preferredStyle: UIAlertControllerStyle = .alert, actions:[DDAlertAction]){
    ...
    override func layoutSubviews() {
        ...
        self.subviewsContainer.layer.masksToBounds = true
        self.subviewsContainer.layer.cornerRadius = 10
    }
